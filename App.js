...
export default function App() {
  ...
  useEffect(() => {
    ...
    Axios.get("https://api.wanikani.com/v2/subjects/1", {
      ...
      params: {}
          ...
          console.log(response.data.data.amalgamation_subject_ids)
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        {!subjectLoading && !reviewLoading && <SubjectInfo subjectData={subjectData} reviewStatData={reviewStatData} foundInData={foundInData}/>}
      </ScrollView>
    </SafeAreaView>
  );
}
